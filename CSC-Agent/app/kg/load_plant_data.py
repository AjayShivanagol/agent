...
if __name__ == "__main__":
    ...
    API_ENDPOINT = "https://code-spaces.dna-prod.app.corpintra.net/il-csc-backend-maven-aws/prod/api/integration_layer/selectionlist/plant/queryAll" 
    
    # Node Configuration
    # <-- IMPORTANT: SET THE LABEL FOR THE NODES YOU ARE CREATING
    NODE_LABEL = "plant_details" 
